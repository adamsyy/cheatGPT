      ...
      <div className={styles['home-main']}>
        <div className={styles['home-heading-description-div']}>
          ...
          <div className={styles['home-description']}>
            <h1>
              The ultimate AI detection bypass tool. Our tool bypasses AI detection from platforms such as undetectable.ai, turnitin, contentatscale.ai, contentdetector.ai, and copyleaks.com.
